...
static u16 sendcount,sendcount1;
extern bool is_open_timer2;
/* @note ATTENTION - please keep this variable 32bit alligned */

/* Private function prototypes -----------------------------------------------*/
static void yReceivePacket(UTCPTRANSDEC *packet,u16 flashsec);
...
{
	yReceivePacket(&packet,flashsec);	
}

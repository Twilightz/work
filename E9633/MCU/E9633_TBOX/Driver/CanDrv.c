...
********************************************************************************
*/
void CAN1Init(CANX *pcan, CANXBAUD baud, u8 is_Filter)
{
...
********************************************************************************
*/
void CAN2Init(CANX *pcan, CANXBAUD baud, u8 is_Filter)
{
    GPIO_InitTypeDef        GPIO_InitStructure;
	  CAN_FilterInitTypeDef   CAN_FilterInitStructure;
    CAN_InitTypeDef         CAN_InitStructure;
...
void CANQUE_TO_CANTXMSG(CanTxMsg* pTxMsg, CANQUEDATA* pCAN)
{
		...
		pTxMsg->DLC = pCAN->Dlc;
		//RTU_DEBUG("pTxMsg->RTR=%x\r\n",pTxMsg->RTR);
		//RTU_DEBUG("pTxMsg->IDE=%x\r\n",pTxMsg->IDE);
		//RTU_DEBUG("pTxMsg->DLC=%x\r\n",pTxMsg->DLC);
		//RTU_DEBUG("pTxMsg->StdId=%x\r\n",pTxMsg->StdId);
		//RTU_DEBUG("pTxMsg->ExtId=%x\r\n",pTxMsg->ExtId);
